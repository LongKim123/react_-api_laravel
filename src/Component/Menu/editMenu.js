...
class EditMenu extends Component{
    ...
    callApiUpdateMenu=()=>{
        ...
        var id=match.params.id;
        try {
            menuApi.Update(id,this.state.namemenu,this.state.parent_id).then(
                (res) =>{
                  console.log(res.data); 
                  this.setState({
                    handlePage:true,
                ...
                <div className="row align-items-center">
                    <form>
                        <div className="mb-3">
                            ...
                            <input onChange={this.change} value={this.state.namemenu}type="type" name="namemenu" className="form-control" />
